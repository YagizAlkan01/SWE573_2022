        ...
        if form.is_valid():
            ...
            if user:
                if user.is_email_verified:
                    ...
                    return HttpResponse('Your account has not been verified yet. Please check your inbox.')
...
def account_view(request, *args, **kwargs):
    ...
    if account:
        ...
        context['education_status'] = account.education_status
        context['phone_number'] = account.phone_number
        context['job_title'] = account.job_title
        context['loyalty_points'] = account.loyalty_points
